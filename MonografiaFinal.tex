...
% M - largura da imagem
% N - altura da imagem
% p_i,j elemente i,j da imagem
% C_i,j cor da imagem no ponto i,j
% Y - luminosidade
%P(a,b) - ponto na GLCM
%i,j posições de imagens
%t - tempo
%I - função iluminaçao da fluxo optico
%v - velocidade fluxo optico
%n - neuronio
%e - entrada do neuronio
%w - peso do neuronio
%s - saida do neuronio
%k - tamanho de vetor
%d - deslocamento do neuronio
